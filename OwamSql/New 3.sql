...
SELECT ASSET_ID, 
    ...
    ADDRESS
  FROM (SELECT DISTINCT  WO.ASSET_ID,
               WOC.WORK_ORDER_NO,
        ...
        SELECT DISTINCT  AL.ASSET_ID,
               ...
               (CASE EMPLOYEE_NO WHEN  NULL THEN 0 WHEN LENGTH(EMPLOYEE_NO) THEN 0 ELSE 1 END) AS "EMPLOYEE_COUNT2",     
               NULL     AS "ADDRESS"
